...
public static class GeoKoneGlobals {
	...
	// Canvas dimensions
	public static final int DEF_CANVAS_WIDTH = 512;
	public static final int DEF_CANVAS_HEIGHT = 512;
	...
	public static final char[] gStrokeJoinModes = { PConstants.MITER, PConstants.BEVEL, PConstants.ROUND };
	public static final char[] gStrokeCapModes = { PConstants.SQUARE, PConstants.PROJECT, PConstants.ROUND };
